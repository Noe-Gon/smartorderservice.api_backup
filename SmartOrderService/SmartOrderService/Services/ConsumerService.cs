...
namespace SmartOrderService.Services
{
    public class ConsumerService : IDisposable
    {
        ...
        {
            using (var trans = UoWConsumer.Context.Database.BeginTransaction())
            {
                ...
                try
                {
                    ...
                    else
                    {
                        ...
                        so_customer deleteCustomer = UoWConsumer.CustomerRepository
                            .Get(x => x.customerId == request.OriginalCustomerId)
                            .FirstOrDefault();
        ...
        public ResponseBase<ConsumerRemovalResponse> ConsumerRemovalRequestRequest(ConsumerRemovalRequestRequest request)
        {
            try
            {
                ...
                if (previousRequestExist != null)
                    ...
                    {
                        Msg = "Ya existe una petición para ese usuario"
                    });
        ...
        public so_products_price_list GetProductPriceList(so_route route)
        {
            ...
            var customerVario = varioService.GetCustomerVarioByRouteId(route.routeId);
        ...
        public void Dispose()
        {
            ...
            this.UoWCRM.Dispose();
            this.UoWCRM = null;
            this.UoWEmBeAlgoritmo.Dispose();
            this.UoWEmBeAlgoritmo = null;
        }
    }
